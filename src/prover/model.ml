...
let visjs_output =
  ...
  let footer chan =
    ...
    output_string chan "      for(var j = 0; j<t.rows.length;j++){\n";
    output_string chan "        if (t.rows[j].cells.length >= 2) {\n";
    output_string chan "          t.rows[j].cells[1].onclick=function(){\n";
    output_string chan "            highlight(this.innerHTML);\n";
    output_string chan "          }\n";
    output_string chan "        }\n";
    output_string chan "      }\n";
    output_string chan "    }\n";
