...
let to_grass h f subst = subst_id subst (ToGrass.to_grass Symbols.pred_to_form h (SlUtil.subst_id subst f))
let to_grass_negated h f subst = subst_id subst (ToGrass.to_grass_negated Symbols.pred_to_form h (SlUtil.subst_id subst f))
let to_grass_not_contained h f subst = subst_id subst (ToGrass.to_grass_not_contained Symbols.pred_to_form h (SlUtil.subst_id subst f))
