...
// Command Line Options: /print:test.bpl /compile:0 test.dfy
...
procedure CheckWellformed$$_module.__default.test(a#0: ref
...
implementation CheckWellformed$$_module.__default.test(a#0: ref)
{
  ...
  $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "test.dfy(3,7): initial state"} true;
    assume a#0 != null;
    havoc i#0;
    assume LitInt(0) <= i#0;
    assert a#0 != null;
...
procedure InterModuleCall$$_module.__default.test(a#0: ref
       where $Is(a#0, Tclass._System.array(TInt))
         && $IsAlloc(a#0, Tclass._System.array(TInt), $Heap));
  // user-defined preconditions
  requires a#0 != null;
  requires (exists i#1: int :: 
...
procedure IntraModuleCall$$_module.__default.test(a#0: ref
       where $Is(a#0, Tclass._System.array(TInt))
         && $IsAlloc(a#0, Tclass._System.array(TInt), $Heap));
  // user-defined preconditions
  requires a#0 != null;
...
procedure Impl$$_module.__default.test(a#0: ref
       where $Is(a#0, Tclass._System.array(TInt))
         && $IsAlloc(a#0, Tclass._System.array(TInt), $Heap))
...
implementation Impl$$_module.__default.test(a#0: ref) returns ($_reverifyPost: bool)
{
  var $_Frame: <beta>[ref,Field beta]bool;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
  $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "test.dfy(5,1): initial state"} true;
    $_reverifyPost := false;
}



procedure CheckWellformed$$_module.__default.foo(a#0: ref
       where $Is(a#0, Tclass._System.array(TInt))
         && $IsAlloc(a#0, Tclass._System.array(TInt), $Heap));
...
implementation CheckWellformed$$_module.__default.foo(a#0: ref)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var i#0: int;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
  $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "test.dfy(8,7): initial state"} true;
    assume a#0 != null;
    havoc i#0;
    if (*)
    {
...
procedure InterModuleCall$$_module.__default.foo(a#0: ref
       where $Is(a#0, Tclass._System.array(TInt))
         && $IsAlloc(a#0, Tclass._System.array(TInt), $Heap));
  // user-defined preconditions
  requires a#0 != null;
...
procedure IntraModuleCall$$_module.__default.foo(a#0: ref
       where $Is(a#0, Tclass._System.array(TInt))
         && $IsAlloc(a#0, Tclass._System.array(TInt), $Heap));
  // user-defined preconditions
  requires a#0 != null;
...
procedure Impl$$_module.__default.foo(a#0: ref
       where $Is(a#0, Tclass._System.array(TInt))
         && $IsAlloc(a#0, Tclass._System.array(TInt), $Heap))
   returns ($_reverifyPost: bool);
  free requires 0 == $ModuleContextHeight && 1 == $FunctionContextHeight;
...
implementation Impl$$_module.__default.foo(a#0: ref) returns ($_reverifyPost: bool)
{
  var $_Frame: <beta>[ref,Field beta]bool;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha :: 
  $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "test.dfy(10,1): initial state"} true;
    $_reverifyPost := false;
}
